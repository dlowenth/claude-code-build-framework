...
- **Testing:** Role-based test cases maintained as a living document in the repository, with browser verification for UI, console, and network behavior. A strict rule against deleting production data during development or testing.
